...
# ---------------------------------------------------------------------------
# Quantum process tensor
# ---------------------------------------------------------------------------
def generate_kraus_process_tensor(
    num_samples: int = 1,
    num_slots: int = 1,
    ...
    """
    Sample n-slot quantum combs by linking an Encoder and Decoder via an environment.

    Returns
    -------
    combs : torch.Tensor
        Shape (n, r_dec, d_2i * d_0o, d_1o * d_1i)
    ...
    E = generate_kraus_channel(num_samples=num_samples, dim=(d_1i * d_env, d_0o), M=1)
